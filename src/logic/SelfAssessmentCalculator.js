...
const SE_CONSTANTS = {
    '2025/26': {
        ...
        class4MainRate: 0.06,                // 6% from April 2024
    ...
    '2024/25': {
        ...
        class2SmallProfitsThreshold: 6725,
        class2LowerProfitsThreshold: 12570,
        class4MainRate: 0.06,                  // 6% (Autumn Statement 2023 / Budget 2024)
        class4UpperRate: 0.02,
        class4LowerLimit: 12570,
        class4UpperLimit: 50270,
        mileageRate1: 0.45,
 ...
 */
export const calculateClass2NI = () => {
    return { amount: 0, note: 'Class 2 NI is abolished for mandatory payments from April 2024. NI credit still applies if profit > £6,725.' };
};
